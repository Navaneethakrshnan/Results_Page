        ...
        <section className="text-gray-600 mt-5 body-font overflow-hidden">
          <div className="container px-10 lg:py-24 md:py-12 sm:py-10 py-10 2xl:mx-auto">
            <div className="flex flex-wrap -m-12 lg:items-start justify-center">
              <div className="p-8 2xl:w-[43rem] xl:w-[37rem] lg:w-[30rem] md:w-[40rem] sm:w-[32rem] w-[25rem] flex flex-col items-start">
                <div>
              ...
              <div className="p-8 2xl:w-[43rem] xl:w-[37rem] lg:w-[30rem] md:w-[40rem] sm:w-[32rem] w-[25rem] -mt-10 lg:mt-0 flex flex-col items-start">
                <div className="pb-10 mb-4 pl-8 sm:pl-12 border pt-7 border-grey-300 lg:mt-6">
                  <h2 className="text-lg font-medium -ml-3 justify-start text-left text-gray-700 mb-4">
                    CONTACT
                  </h2>
            ...
            <div className="mt-4 lg:px-16 block">
              <label
                htmlFor="lastName"
              ...
              <button
                type="submit"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 font-medium rounded-lg text-sm px-5 py-4 me-2 mb-2"
              >
                Register
              </button>
            </div>
